...
public class AircraftFactory {
	...
	public Flyable newAirCraft(String p_type, String p_name, int longitude, int latidute, int height) {
		...
		if (p_type.equals("Baloon")) {
			System.out.println("baloon create");
			Flyable baloon = new Baloon(0, p_name, coordinates);
			return baloon;
		}
		if (p_type.equals("Helicopter")) {
			System.out.println("helicopter create");
			Flyable helicopter = new Helicopter(0, p_name, coordinates);
			return helicopter;
		}
		if (p_type.equals("JetPlane")) {
			System.out.println("jetplane create");
			Flyable jetplane = new JetPlane(0, p_name, coordinates);
			return jetplane;
		}
